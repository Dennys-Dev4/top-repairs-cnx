...
export const services: ServiceCategory[] = [
  {
    ...
    color: '#F59E0B',
    items: [
      { key: 'socket', price: 500, priceRange: [500, 800] },
      { key: 'lighting', price: 500, priceRange: [500, 1500] },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'cctv_inspect', price: 500, priceRange: [500, 800] },
      { key: 'dvr_setup', price: 500, priceRange: [500, 1500] },
      { key: 'remote_view', price: 500, priceRange: [500, 800] },
    ],
  },
  {
    slug: 'general',
    ...
    color: '#10B981',
    items: [
      { key: 'door', price: 500, priceRange: [500, 1500] },
      { key: 'plumbing', price: 500, priceRange: [500, 2000] },
      { key: 'furniture', price: 500, priceRange: [500, 1500] },
      { key: 'paint', price: 500, priceRange: [500, 3000] },
      { key: 'mount', price: 500, priceRange: [500, 800] },
    ],
  },
];
